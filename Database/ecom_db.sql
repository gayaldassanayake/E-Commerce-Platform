...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2019 at 06:18 PM
...
('11638', 'Tools', NULL, 1),
('22554', 'Books', NULL, 1),
('24206', 'Clothing', NULL, 1),
('37879', 'Accessories', NULL, 1),
('52432', 'Crafts', NULL, 0),
('74883', 'Audible', NULL, 1),
('86148', 'Office', NULL, 0),
('87267', 'Clothing', NULL, 0),
('93854', 'Food', NULL, 0),
('99298', 'Books', NULL, 1);
...
('13550', '1871 Hunting Hill Way, Penobscot Building, Indianapolis, Indiana, 80465', 'Beatty@nowhere.com', 'Funeral Service And Crematories', 'Lynwood893', 'pdQC/iulev/miNAzyqV0DQ==', 0),
...
('07564', 'Delivered', 'Store Pickup', 'Credit Card', '4405646854899278', NULL, '2006', '2', 'Abram Koontz', '81 Fox Hill Drive, Little Rock, AR, 16919', NULL, '11004'),
('08545', 'Deliverying', 'Delivered', 'Cash on Delivery', '5568595127874024', '293', '2013', '9', 'Stacey Mccune', '984 Town Ct, Juneau, AK, 89927', '8', '66974'),
...
('17759', 'Waiting for Customer', 'Delivered', 'Cash on Delivery', '5457938537189738', '485', '2009', '2', 'Garth Stahl', '3323 Social Highway, Suite 752, Cheyenne, WY, 52672', '1', '41899'),
('27379', 'Deliverying', 'Delivered', 'Cash on Delivery', '5340778747084563', '196', '2007', '3', 'Holly Estrada', '1551 North Quailwood Highway, 1st FL, Sacramento, CA, 44675', '8', '75249'),
...
('54611', 'Deliverying', 'Delivered', 'Cash on Delivery', '5308756532464745', '246', '2018', '8', 'Adelaide Bridges', '2607 NE Ashwood Ln, Dover, DE, 42593', '3', '57878'),
('89927', 'Waiting for Customer', 'Delivered', 'Cash on Delivery', '5452934641940707', '756', '2023', '9', 'Letha Begley', '217 S Highland Loop, Appartment 2, Lansing, Michigan, 67907', '16', '75249');
...
('15731', '66376', 'UVY', 'Consequuntur ratione libero sed.', '716.33', 49, 0, '158.14', 29, 'http://babiwi.teranbutit.se/thahaor/ingaluld/ndesherere.pdf'),
('16113', '38282', '6F', 'Ut quia dolore voluptas pariatur eos.', '820.39', 57, 0, '238.91', 79, 'https://watomi.andoul.no/not/thithednt.txt'),
('31875', '51082', 'AJ', 'Ex odit error.', '601.23', 2, 0, '1605.23', 66, 'http://seall.mx/thias/ar/eanean/haedarete.pdf'),
('55816', '23943', '811JS', 'Molestias praesentium minima et.', '447.28', 94, 1, '1985.28', 62, 'https://astheedse.il/mever/newaere/ted/ndeveresho.pdf'),
('64049', '67863', '33', 'Est qui facilis quis soluta qui sit.', '827.30', 59, 0, '1968.30', 45, 'http://sopoka.tienterte.ch/meorar/tiorehad/itorin/ngouland.pdf'),
('84973', '12760', 'M4G', 'Doloribus quia ut neque saepe tempora.', '508.40', 67, 0, NULL, 95, 'http://yiha.hinetheng.be/anwate/nethhinth.xls'),
('86891', '77637', 'ENB', 'Unde totam enim quidem accusantium.', '596.41', 58, 1, '58.41', 58, 'https://nozuda.allourat.tw/andedit/anforleor.doc'),
('89416', '21283', 'I73', 'Perspiciatis ea voluptatem error.', '327.36', 39, 1, '1624.43', 7, 'http://wiji.inhaes.eg/hinome/eahat/asarome/herall.xls'),
('89733', '56807', 'Y6I', 'Itaque et dolores corporis vel.', '365.14', 32, 0, '1221.39', 30, 'https://youre.au/verewas/nothatwit/waster.xls'),
('92173', '72378', '6', 'Error accusantium ut facere ut.', '409.38', 62, 0, '963.88', 84, 'https://itheraeraare.za/isbutthe/ouve.doc');
...
ALTER TABLE `order_item`
  ADD PRIMARY KEY (`product_id`,`varient_id`,`serial_number`,`order_id`),
...
--
-- AUTO_INCREMENT for table `category_specialized_attribute`
--
ALTER TABLE `category_specialized_attribute`
...
--
-- AUTO_INCREMENT for table `product_category_specialized_attribute`
--
ALTER TABLE `product_category_specialized_attribute`
  MODIFY `attribute_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
