...
--
-- Host: localhost
-- Generation Time: Dec 24, 2019 at 07:38 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `top_sales_proc` (`start_date` DATE, `end_date` DATE)  BEGIN
...
(8276, 'Miyoko Mckinney', 'Mcnally2', 'V4nE+4PqWuTQW67ttUnOSw=='),
...
INSERT INTO `order_` (`order_id`, `state`, `delivery_method`, `payment_method`, `credit_card_number`, `cvv`, `expire_year`, `expire_month`, `name_on_card`, `delivery_address`, `estimate_days`, `delivery_person_id`, `date_`) VALUES
(7564, 'Delivered', 'Store Pickup', 'Credit Card', '4405646854899278', NULL, '2006', '2', 'Abram Koontz', '81 Fox Hill Drive, Little Rock, AR, 16919', '3', 11004, '2019-12-02'),
(8545, 'Deliverying', 'Delivered', 'Cash on Delivery', NULL, NULL, NULL, NULL, NULL, '984 Town Ct, Juneau, AK, 89927', '8', 66974, '2019-12-10'),
(16153, 'Pending', 'Store Pickup', 'Credit Card', '5558842648132975', '727', '2026', '6', 'Catherina Overstreet', '850 Church Ln, Nashville, TN, 22595', '13', 59510, '2019-11-04'),
(17759, 'Waiting for Customer', 'Delivered', 'Cash on Delivery', NULL, NULL, NULL, NULL, NULL, '3323 Social Highway, Suite 752, Cheyenne, WY, 52672', '1', 41899, '2019-12-17'),
(27379, 'Deliverying', 'Delivered', 'Cash on Delivery', NULL, NULL, NULL, NULL, NULL, NULL, '8', 75249, '2019-11-11'),
(34510, 'Pending', 'Store Pickup', 'Credit Card', '4844756594603739', '985', '2007', '8', 'Norberto Abreu', '1016 New Rock Hill Parkway, Madison, WI, 54233', '8', 3175, '2019-10-16'),
(38357, 'Pending', 'Store Pickup', 'Credit Card', '4844756594603731', '539', '2010', '10', 'Kamal', NULL, '5', NULL, '2019-12-17'),
(43408, 'Delivered', 'Store Pickup', 'Credit Card', '4405972852222663', '141', '2018', '3', 'Onita Kurtz', '1594 Ashwood Parkway, Enquirer Building, Harrisburg, PA, 91496', '9', 3175, '2019-12-18'),
(54611, 'Deliverying', 'Delivered', 'Cash on Delivery', NULL, NULL, NULL, NULL, NULL, NULL, '3', 57878, '2019-12-19'),
(89927, 'Waiting for Customer', 'Delivered', 'Cash on Delivery', NULL, NULL, NULL, NULL, NULL, NULL, '16', 75249, '2019-12-04');
...
(64049, 67863, '12345', 7564, '827.30'),
(64049, 67863, '12709', 7564, '827.30'),
(84973, 12760, '54268', 27379, '54.78'),
(86891, 77637, '64870', 34510, '633.38'),
(89416, 21283, '51055', 8545, '961.85'),
(89733, 56807, '35914', 89927, '307.05'),
(92173, 72378, '23456', 7564, '409.38'),
...
-- (See below for the actual view)
--
CREATE TABLE `shop_view_min_max` (
`category_id` int(11)
,`category` varchar(50)
,`product_id` int(11)
,`title` varchar(100)
...
--
-- Stand-in structure for view `top_sales_view`
-- (See below for the actual view)
--
CREATE TABLE `top_sales_view` (
`product_id` int(11)
,`title` varchar(100)
,`description` text
...
--
-- Structure for view `top_sales_view`
--
DROP TABLE IF EXISTS `top_sales_view`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `top_sales_view`  AS  (select `product`.`product_id` AS `product_id`,`product`.`title` AS `title`,`product`.`description` AS `description`,`product`.`manufacturer` AS `manufacturer`,`product`.`rating` AS `rating`,count(0) AS `Number_of_sales` from ((`product` join `order_`) join `order_item`) where ((`order_`.`order_id` = `order_item`.`order_id`) and (`order_item`.`product_id` = `product`.`product_id`)) group by `order_item`.`product_id` order by count(0) desc limit 100) ;
...
--
ALTER TABLE `administrator`
  MODIFY `admin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86850;

--
-- AUTO_INCREMENT for table `category`
--
ALTER TABLE `category`
  MODIFY `category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99299;
...
--
-- AUTO_INCREMENT for table `credit_card_detail`
--
ALTER TABLE `credit_card_detail`
  MODIFY `customer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80186;
...
--
ALTER TABLE `delivery_person`
  MODIFY `delivery_person_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88656;

--
-- AUTO_INCREMENT for table `order_`
--
ALTER TABLE `order_`
  MODIFY `order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89928;

--
-- AUTO_INCREMENT for table `product`
--
ALTER TABLE `product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92174;
